 ...
 * Used to print text with @see {@link ChatRoomTextArea#addText(String, Font, Color)}
 * 
 * @author Ornicare
 *
 */
public class ChatRoomTextArea extends JTextPane {
     ...
     * 
     * @see ChatRoomTextArea#setDefaultFont()
     * @see ChatRoomTextArea#getDefaultFont(Font)
     */
     ...
     * Defaukt to white
     * 
     * @see ChatRoomTextArea#setDefaultColor()
     * @see ChatRoomTextArea#getDefaultColor(Color)
     */
     ...
     * Default to black
     * 
     * @see ChatRoomTextArea#getDefaultColorBackground()
     * @see ChatRoomTextArea#setDefaultColorBackground(Color)
     */
	private Color defaultColorBackground = Color.BLACK;
	
	/**
     * Content of the @see {@link ChatRoomTextArea#textPane}
     * 
     * @see ChatRoomTextArea#getDefaultColorBackground()
     * @see ChatRoomTextArea#setDefaultColorBackground(Color)
     */
	...
	private ChatRoomTextArea textPane;
...
//		this.setVisible(true);	
	 ...
	 *
	 * @see ChatRoomTextArea#addText(String ,Font, Color)
	 */
