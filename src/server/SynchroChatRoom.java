 ...
 *
 */
public class SynchroChatRoom extends UnicastRemoteObject implements IChatRoom {
    ...
    public SynchroChatRoom(String name, Server server, String owner)
...
//				    diffuse(listener.getPseudo()+" have been deconnected.");
	...
	public void notifyAllClients() {
		for(IMessageListener client : remoteClientsList) {
			try {
				client.actualise();
			} catch (RemoteException e) {}
		}
